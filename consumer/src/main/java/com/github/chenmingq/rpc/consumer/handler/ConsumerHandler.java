package com.github.chenmingq.rpc.consumer.handler;
...
import com.github.chenmingq.rpc.consumer.process.ProcessPool;
 ...
 * @author : cmq
 * date : 2021/01
 * description : 消费着连接提供者
 */
@Slf4j
@ChannelHandler.Sharable
public class ConsumerHandler extends BaseChannelHandler<BaseMessage> {
